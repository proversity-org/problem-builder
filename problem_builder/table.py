...
class MentoringTableBlock(
    ...
    def student_view(self, context):
        ...
        fragment.add_javascript_url('cdn.rawgit.com/MrRio/jsPDF/master/dist/jspdf.min.js')
        fragment.add_javascript_url('cdn.rawgit.com/niklasvh/html2canvas/0.5.0-alpha2/dist/html2canvas.min.js')
